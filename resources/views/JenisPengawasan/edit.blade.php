                ...
                <div class="nftmax-body">
                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="nftmax-inner__heading">
                            <h2 class="nftmax-inner__page-title">Edit Data Jenis Pengawasan </h2>
                        </div>
                        <!-- End All Notification Heading -->
                        <div class="nftmax__item">
                            <div class="nftmax__item-heading">
                                <h2 class="nftmax__item-title nftmax__item-title--psingle">Silahkan Edit Nama dan Kode tentang Jenis Pengawasan</h2>
                                <p class="nftmax__item-text nftmax__item-text--single">Mohon Edit Jenis Yang Valid!</p>
                            </div>
