                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="nftmax__item">
                            <div class="nftmax__item-heading">
                                <h2 class="nftmax__item-title nftmax__item-title--psingle">Silahkan Input Data Jenis Pengawasan Sesuai Dengan Kriteria!</h2>
                                <p class="nftmax__item-text nftmax__item-text--single">Mohon Input Data Yang Valid!</p>
                            </div>
                            <form class="form" method="POST" action="{{ url('/jenis-pengawasan/store') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="nftmax__item-box jenis-pengawasan-box">
                                            ...
                                            <div class="nftmax__item-form--group">
                                                ...
                                                <input class="nftmax__item-input" type="number" placeholder="Input Kode Jenis Pengawasan" required="required"
                                                    name="kode">
                                            </div>
                                            
                                            <div class="nftmax__item-form--group">
                                                <label class="nftmax__item-label">Nama</label>
                                                <input class="nftmax__item-input" type="text" placeholder="Input Nama Jenis Pengawasan" required="required"
                                                    name="nama">
                                            </div>
