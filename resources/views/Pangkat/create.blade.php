                ...
                <div class="nftmax-body">
                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="nftmax-personals">
                            ...
                            <h2 class="nftmax__item-title nftmax__item-title--psingle">Silahkan Input Data Pangkat Sesuai Dengan Kriteria!</h2>
                                                    ...
                                                    <div class="nftmax__item-box">
																											...
																											<div class="nftmax__item-form--group">
																													...
																													<div class="input-group input-group-sm">
																															<input type="text" class="form-control" name="golongan_kode_kiri" placeholder="Input, I, II, III, IV" style="height: 40px;" required>
																															<div class="input-group-append">
																																	<span class="input-group-text" style="height: 40px;">/</span>
																															</div>
																															<input type="text" class="form-control" name="golongan_kode_kanan" placeholder="Input, a, b, c, d" style="height: 40px;" required>
																													</div>
																											</div>
