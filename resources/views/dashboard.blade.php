												...
												<div class="seller-list__slider">
                                                    ...
                                                    <div class="seller-list__single-slider">
														<div class="seller-list__single">
															<!-- Seller Head -->
															<div class="seller-list__head">
																<div class="verfify-sign"><img src="{{asset($TopBuyer['0'])}}" alt="#"></div>
																<img src="{{asset($TopBuyer['1'])}}" alt="#">
															</div>
															<!-- Seller Body -->
															<div class="seller-list__body">
																<h4 class="sell-list__title"><a href="#">{{$TopBuyer['2']}}</a></h4>
																<p class="sell-list__author"><a href="#">{{$TopBuyer['3']}}</a></p>
																<div class="sell-list__item sell-list__v2 nftmax-pcolor"><img src="{{asset($TopBuyer['4'])}}" alt="#">${{$TopBuyer['5']}} M</div>
															</div>
														</div>
													</div>
                                                    @endforeach
