							...
							<div class="nftmax-body">
								...
								<div class="nftmax-dsinner">
									...
									<div class="nftmax-inner__heading">
										<h2 class="nftmax-inner__page-title">Tambah Jenjang Jabatan Baru</h2>
									</div>
									...
									<div class="nftmax__item">
										...
										<div class="nftmax__item-heading">
											<h2 class="nftmax__item-title nftmax__item-title--psingle">Silahkan Inputkan Informasi Terkait Jenjang Jabatan</h2>
											<p class="nftmax__item-text nftmax__item-text--single">Mohon Input Data Yang Valid!</p>
										</div>
										<form class="form" method="POST" action="{{ url('jenjangJabatan/store') }}">
                      @csrf
											<div class="row">
												<div class="col-12">
                                  ...
                                  <div class="nftmax__item-form--group">
																	...
																	<div class="nftmax__item-form--group">
																		...
																		<input class="nftmax__item-input" type="text" name="level" id="level" placeholder="Input Level" required="required">
																	</div>
