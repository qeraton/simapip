                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="welcome-cta mg-top-40">
                            <div class="welcome-cta__heading">
                                <h2 class="welcome-cta__title">Seluruh Daftar Jenjang Jabatan</h2>
                                <p class="welcome-cta__text">Anda dapat menambahkan dan mengubah Jenjang Jabatan di
                                    module ini.</p>
                            </div>
                            @can('Create Jenjang Jabatan')
                                <div class="welcome-cta__button">
                                    <a href="{{ url('/jenjangJabatan/create') }}"
                                        class="nftmax-btn nftmax-btn__bordered bg radius">Tambah Data Jenjang Jabatan
                                    </a>
                                </div>
                            @endcan
                        ...
                        <div class="nftmax-table mg-top-40">
                            <div class="nftmax-table__heading">
                                <h3 class="nftmax-table__title mb-0">Data Jenjang Jabatan
                                    ...
                                    <table id="myTable" class="nftmax-table__main nftmax-table__main-v1">
                                        ...
                                        <thead class="nftmax-table__head">
                                            <tr>
                                                ...
                                                <th class="nftmax-table__column-3 nftmax-table__h2">Level</th>
                                            ...
                                            @foreach ($jenJab as $item)
                                                <tr>
                                                    ...
                                                    <td class="nftmax-table__column-4 nftmax-table__data-3">
                                                        @can('Edit Jenjang Jabatan')
                                                            <a href="{{ url('/jenjangJabatan/edit', $item['id']) }}" class="btn btn-primary me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16"><path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/><path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/></svg> Edit</a>
                                                        @endcan
                                                        @can('Delete Jenjang Jabatan')
                                                            ...
                                                            <div class="modal-dialog modal-confirm modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer justify-content-center">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('/jenjangJabatan/delete', $item['id']) }}"
