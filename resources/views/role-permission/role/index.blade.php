                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="welcome-cta mg-top-40">
                            <div class="welcome-cta__heading">
                                <h2 class="welcome-cta__title">Role</h2>
                                <p class="welcome-cta__text">Anda dapat menambahkan dan mengubah Role di
                                    module ini.</p>
                            </div>
                            <div class="welcome-cta__button">
                                <a href="{{ url('roles/create') }}"
                                    class="nftmax-btn nftmax-btn__bordered bg radius">Tambah Role</a>
                            </div>
                        </div>
                        <!-- End Welcome CTA -->
                                                            ...
                                                            <div class="modal-dialog modal-confirm modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Apakah Anda Yakin Ingin Menghapus Data Ini?. Data Yang Akan Dihapus : <b style="color: #f44336">{{$item->name}}</b></p>
                                                                    </div>
                                                                    <div class="modal-footer justify-content-center">
                                                                        <button type="button" data-dismiss="modal" aria-label="btn-cancel" class="btn btn-secondary btn-cancel">Tidak</button>
                                                                        <form
                                                                            action="{{ url('roles/'.$item->id.'/delete') }}"
