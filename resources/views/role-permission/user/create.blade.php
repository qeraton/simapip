                ...
                <div class="nftmax-body">
                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="nftmax-inner__heading">
                            <h2 class="nftmax-inner__page-title">Tambah User</h2>
                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="nftmax__item-box">
                                            <div class="nftmax__item-form--group">
                                                ...
                                                <input class="nftmax__item-input" type="text" name="username" placeholder="Input username" required="required">     
                                            </div>
                                            <div class="nftmax__item-form--group">
                                                <label class="nftmax__item-label">Email </label>
                                                <input class="nftmax__item-input" type="text" name="email" placeholder="Input email" required="required">     
                                            </div>
                                            <div class="nftmax__item-form--group">
                                                <label class="nftmax__item-label">Password </label>
                                                <input class="nftmax__item-input" type="text" name="password" placeholder="Input password" required="required">     
                                            </div>
                                            <div class="nftmax__item-form--group">
