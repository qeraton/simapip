                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="welcome-cta mg-top-40">
                            <div class="welcome-cta__heading">
                                <h2 class="welcome-cta__title">Seluruh Daftar Strata Pendidikan</h2>
                                <p class="welcome-cta__text">Anda dapat menambahkan dan mengubah Strata Pendidikan di
                                    module ini.</p>
                            </div>
                            <div class="welcome-cta__button">
                                @can('Create Strata Pendidikan')
                                    <a href="{{ url('/strata-pendidikan/create') }}"
                                    class="nftmax-btn nftmax-btn__bordered bg radius">Tambah Strata Pendidikan</a>
                                @endcan   
                            </div>
                        </div>
                        <!-- End Welcome CTA -->
                        <div class="nftmax-table mg-top-40">
                            <div class="nftmax-table__heading">
                                <h3 class="nftmax-table__title mb-0">Data Strata Pendidikan
                                                            ...
                                                            <div class="modal-dialog modal-confirm modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer justify-content-center">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('/strata-pendidikan/delete', $item['id']) }}"
