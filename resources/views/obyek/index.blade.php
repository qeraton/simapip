                                    ...
                                    <table id="myTable" class="nftmax-table__main nftmax-table__main-v1">
                                        ...
                                        <thead class="nftmax-table__head">
                                            <tr>
                                                ...
                                                <th class="nftmax-table__column-3 nftmax-table__h3">Aksi</th>
                                            </tr>
                                        </thead>
                                        <!-- NFTMax Table Body -->
                                                            ...
                                                            <div class="modal-dialog modal-confirm modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Apakah Anda Yakin Ingin Menghapus Data Ini?. Data Yang Akan Dihapus : <b style="color: #f44336">{{$item->kode}}</b></p>
                                                                    </div>
