					...
					<div class="admin-menu__three mg-top-50">
						...
						<div class="menu-bar">
							<ul class="menu-bar__one">
								...
								<li class="{{ Request::path() == 'users' ? 'active' : '' }}"><a href="{{url('users')}}"><span class="menu-bar__text"><span class="nftmax-menu-icon nftmax-svg-icon__v10"><svg class="nftmax-svg-icon role-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16"><path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm5-3a4 4 0 0 0-3.598 2.244A4 4 0 0 0 1 12c0 .88.895 1.6 2 1.6h10c1.105 0 2-.72 2-1.6a4 4 0 0 0-2.402-3.756A4 4 0 0 0 13 6z"/></svg></span><span class="menu-bar__name">Users</span></span></a></li>
							</ul>
						</div>
						<!-- End Nav Menu -->
					</div>
