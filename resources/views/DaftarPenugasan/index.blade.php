                    ...
                    <div class="nftmax-dsinner">
                        ...
                        <div class="welcome-cta mg-top-40">
                            <div class="welcome-cta__heading">
                                <h2 class="welcome-cta__title">Seluruh Daftar Penugasan</h2>
                                <p class="welcome-cta__text">Anda dapat menambahkan dan mengubah Daftar Penugasan di
                                    module ini.</p>
                            </div>
                            <div class="welcome-cta__button">
                                @can('Create Daftar Penugasan')
                                    <a href="{{ url('/daftar-penugasan/create') }}"
                                    class="nftmax-btn nftmax-btn__bordered bg radius">Tambah Daftar Penugasan</a>
                                @endcan   
                            </div>
                        </div>
                        <!-- End Welcome CTA -->
                        <div class="nftmax-table mg-top-40">
                            <div class="nftmax-table__heading">
                                <h3 class="nftmax-table__title mb-0">Data Penugasan
