                                                ...
                                                <tr>
                                                    ...
                                                    <td class="nftmax-table__column-10 nftmax-table__data-10">
                                                        ...
                                                        @can('Edit Daftar Unit Kerja')
                                                            <a href="{{ url('/unit-kerja/edit', $item['id']) }}" class="btn btn-warning me-1">
                                                            ...
                                                            <div class="modal-dialog modal-confirm modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <p>Apakah Anda Yakin Ingin Menghapus Data Ini?. Data Yang Akan Dihapus : <b style="color: #f44336">{{$item->kode_unit_kerja}}</b></p>
                                                                    </div>
