...
Route::group(['middleware' => ['authenticated']], function () {
    ...
    Route::group(['prefix' => 'jenis-pengawasan'], function () {
        ...
        Route::get('/edit/{id}', [JenisPengawasan::class, 'edit'])->name('Edit Data');
    ...
    Route::group(['prefix' => 'daftar-penugasan'], function () {
        ...
        Route::get('/edit/{id}', [DaftarPenugasan::class, 'edit'])->name('Edit Data');
    ...
    Route::group(['prefix' => 'obyek'], function () {
        ...
        Route::get('/edit/{id}', [Obyek::class, 'edit'])->name('Edit Data');
    ...
    Route::group(['prefix' => 'strata-pendidikan'], function () {
        ...
        Route::get('/edit/{id}', [StrataPendidikan::class, 'edit'])->name('Edit Data');
    ...
    Route::group(['prefix' => 'unit-kerja'], function () {
        ...
        Route::get('/edit/{id}', [UnitKerja::class, 'edit'])->name('Edit Data');
    ...
    Route::group(['prefix' => 'jenjangJabatan'], function () {
        ...
        Route::get('/edit/{id}', [jenJabatan::class, 'edit'])->name('Edit Data');
    ...
    Route::group(['prefix' => 'jabatan'], function () {
        ...
        Route::get('/edit/{id}', [jabatan::class, 'edit'])->name('Edit Data');
    ...
    Route::group(['prefix' => 'pangkat'], function () {
        Route::get('/', [pangkat::class, 'index'])->name('index.pangkat');
        Route::get('/list', [pangkat::class, 'listPangkat'])->name('list.pangkat');
        Route::get('/create', [pangkat::class, 'create'])->name('create.pangkat');
        Route::post('/store', [pangkat::class, 'store'])->name('store.pangkat');
        Route::get('/edit/{id}', [pangkat::class, 'edit'])->name('edit.pangkat');
        Route::patch('/update/{id}', [pangkat::class, 'update'])->name('update.pangkat');
        Route::delete('/delete/{id}', [pangkat::class, 'destroy'])->name('delete.pangkat');
    })->name('pangkat');

    Route::group(['prefix' => 'kartu-penugasan'], function () {
        Route::get('/', [KartuPenugasan::class, 'index'])->name('index.kartu-penugasan');
        Route::get('/kartu-penugasan/{id}', [KartuPenugasan::class, 'show'])->name('show.kartu-penugasan');
        Route::get('/create', [KartuPenugasan::class, 'create'])->name('create.kartu-penugasan');
        Route::post('/store', [KartuPenugasan::class, 'store'])->name('store.kartu-penugasan');
        Route::get('/edit/{id}', [KartuPenugasan::class, 'edit'])->name('edit.kartu-penugasan');
        Route::patch('/update/{id}', [KartuPenugasan::class, 'update'])->name('update.kartu-penugasan');
        Route::delete('/delete/{id}', [KartuPenugasan::class, 'destroy'])->name('delete.kartu-penugasan');
    })->name('kartu-penugasan');

    Route::group(['prefix' => 'PKPT'], function () {
        Route::get('/', [PKPT::class, 'index'])->name('index.PKPT');
        Route::get('/get-unit-kerja', [PKPT::class, 'getUnitKerja'])->name('getUnitKerja.PKPT');
        Route::get('/create', [PKPT::class, 'create'])->name('create.PKPT');
        Route::post('/store', [PKPT::class, 'store'])->name('store.PKPT');
        Route::get('/edit/{id}/', [PKPT::class, 'edit'])->name('edit.PKPT');
        Route::patch('/update/{id}/', [PKPT::class, 'update'])->name('update');
        Route::delete('/delete/{id}/', [PKPT::class, 'destroy'])->name('delete.PKPT');
    })->name('PKPT');

    Route::group(['prefix' => 'RPKH'], function () {
        Route::get('/', [RPKH::class, 'index'])->name('index.RPKH');
        Route::get('/RPKH/{id}', [RPKH::class, 'show'])->name('show.RPKH');
        Route::get('/list', [RPKH::class, 'listRPKH'])->name('list.RPKH');
        Route::get('/create', [RPKH::class, 'create'])->name('create.RPKH');
        Route::post('/store', [RPKH::class, 'store'])->name('store.RPKH');
        Route::get('/edit/{id}', [RPKH::class, 'edit'])->name('edit.RPKH');
        Route::patch('/update/{id}', [RPKH::class, 'update'])->name('update.RPKH');
        Route::delete('/delete/{id}', [RPKH::class, 'destroy'])->name('delete.RPKH');
    })->name('RPKH');

    Route::group(['prefix' => 'Reviu'], function () {
        Route::get('/', [Reviu::class, 'index'])->name('index.reviu');
        Route::get('/Reviu/{id}', [Reviu::class, 'show'])->name('show.reviu');
        Route::get('/create', [Reviu::class, 'create'])->name('create.reviu');
        Route::post('/store', [Reviu::class, 'store'])->name('store.reviu');
        Route::get('/edit/{id}', [Reviu::class, 'edit'])->name('edit.reviu');
        Route::patch('/update/{id}', [Reviu::class, 'update'])->name('update.reviu');
        Route::delete('/delete/{id}', [Reviu::class, 'destroy'])->name('delete.reviu');
    })->name('Reviu');

    Route::group(['prefix' => 'my-profile'], function () {
        Route::get('/', [profile::class, 'index'])->name('index.my-profile');
        Route::get('/list', [profile::class, 'listPangkat'])->name('list.my-profile');
        Route::get('/create', [profile::class, 'create'])->name('create.my-profile');
        Route::post('/store', [profile::class, 'store'])->name('store.my-profile');
        Route::get('/edit/{id}', [profile::class, 'edit'])->name('edit.my-profile');
        Route::patch('/update/{id}', [profile::class, 'update'])->name('update.my-profile');
        Route::delete('/delete/{id}', [profile::class, 'destroy'])->name('delete.my-profile');
    })->name('my-profile');
